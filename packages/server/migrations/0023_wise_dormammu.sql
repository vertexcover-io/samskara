...
ALTER TABLE "projects" ADD COLUMN "repoId" uuid;--> statement-breakpoint
ALTER TABLE "repos" ADD COLUMN "ownerOrgId" uuid;--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_repoId_repos_id_fk" FOREIGN KEY ("repoId") REFERENCES "public"."repos"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
